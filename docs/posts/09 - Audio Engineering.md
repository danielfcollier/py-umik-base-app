...
To solve this, I shifted the project's primary metric from RMS to **LUFS (Loudness Units Full Scale)** within the `src/umik_base_app/processing/audio_metrics.py` module.
...
| **Project Integration** | Legacy / Raw Data | **Active** (`src/umik_base_app/processing/audio_metrics.py`) |
