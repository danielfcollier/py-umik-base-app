...
In my [py-umik-base-app](https://github.com/danielfcollier/py-umik-base-app/), I tackled this problem head-on using the **MiniDSP UMIK-1** and some robust Digital Signal Processing (DSP).
