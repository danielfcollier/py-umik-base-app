...
To build your own application using the `umik-base-app` library, see [docs/FRAMEWORK.md](./docs/FRAMEWORK.md) — it covers the full public API, custom sinks and transformers, calibration architecture, device profiles, and how to add new CLI commands.