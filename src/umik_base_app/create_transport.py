...
def create_transport(
    mode: OperationalMode, zmq_host: str | None = None, zmq_port: int | None = None, zmq_messages: int | None = None
) -> AudioTransport:
    """
    Factory to create the correct transport instance based on the application mode.

    :param mode: The operational mode of the application (OperationalMode enum).
    ...
    elif mode == OperationalMode.CONSUMER:
