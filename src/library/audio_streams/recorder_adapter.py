...
This module implements the `AudioSink` protocol, allowing the `AudioStreamsRecorder`
...
class AudioStreamsRecorderAdapter(AudioSink):
    """
    Adapts the RecordingManager to the AudioSink protocol.
    """

    def __init__(self, manager: AudioStreamsRecorder):
        """
